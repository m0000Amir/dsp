...
def orthogonal_matching_pursuit(A, y, num_groups, group_size, sparsity,
                                tol=1e-6):
    """
    ...
    for _ in tqdm(range(sparsity), desc="OMP Progress"):
        # Compute correlation for each available group
        group_correlations = []
        ...
        # Solve least squares for selected groups
